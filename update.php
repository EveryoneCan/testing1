      ...
      <div class="container">
         <main>
            ...
            <div class="col-md-7 col-lg-8">
               ...
               <form class="needs-validation" action="updateA.php"  method="POST" novalidate>
                  <div class="row g-3">
                     
                     <div class="col-md-4">
                     <label for="firstName" class="form-label">Id Number</label>
                    <input type="text" class="form-control" placeholder="" value=""  id="vaidNumber" name="vaidNumber" >
